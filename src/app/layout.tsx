...
export const metadata: Metadata = {
  title: "LuxeStay - Luxury Hotel Booking | Premium Accommodations",
  description: "Experience luxury hospitality at LuxeStay. Book elegant rooms and suites with world-class amenities, fine dining, spa services, and breathtaking views.",
  keywords: "luxury hotel, premium accommodations, resort booking, fine dining, spa hotel",
  openGraph: {
    title: "LuxeStay - Your Next Perfect Escape",
    description: "Book luxury rooms and suites with world-class amenities at LuxeStay Hotels.",
    siteName: "LuxeStay",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1763921345216-6au8aice.jpg",
  ...
  twitter: {
    ...
    description: "Experience premium hospitality with stunning views and world-class service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1763921345216-6au8aice.jpg"]
  },
  robots: {
    index: true,
    follow: true
